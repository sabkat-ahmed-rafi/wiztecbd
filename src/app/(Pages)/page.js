    ...
    return (
        <RootSection>
            ...
            <Section id="serveClient">
                <div className="md:py-100 py-12 !-z-50">
            ...
            <Section id="findBest-home" bgColor={"#17afb0"}>
                <div className=" container mx-auto px-4 max-w-2xl md:py-100 py-12">
                    <OurProcess />
                </div>
            </Section>
            ...
            <Section id="ourCaseStudies" bgColor="#17a2b8">
                <div className=" text-white container mx-auto px-4 max-w-xl  md:py-100 py-12">
                    <OurCaseStudies />
                </div>
            </Section>
